...
//    }
    ...
    private func setupUI(){
        ...
        heartButtonNavigationBar.addTarget(self, action: #selector(openWishlistScreen), for: .touchUpInside)
    }
    
    @objc
    private func openWishlistScreen() {
        print("123")
        navigationController?.pushViewController(WishlistAssembly().build(), animated: true)
    }
}
