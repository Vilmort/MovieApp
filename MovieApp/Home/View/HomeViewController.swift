...
final class HomeViewController: ViewController {
    ...
    private let collectionView: HomeViewProtocol
    private let navigationAndSearchBarView:NavigationAndSearchBarViewProtocol
    ...
    init(
        ...
        navigationAndSearchBarView:NavigationAndSearchBarViewProtocol
    ) {
        self.collectionView = homeView
        self.presenter = presenter
        self.navigationAndSearchBarView = navigationAndSearchBarView
...
extension HomeViewController {
    ...
    enum Section: Int, CaseIterable {
     ...
     enum Item: Hashable {
        ...
        case mostPopular(KPMovieSearchEntity.KPSearchMovie)
    }
}
...
private extension HomeViewController {
    ...
    func makeMostPopularCellRegistration() -> UICollectionView.CellRegistration<MostPopularFilmsCell, KPMovieSearchEntity.KPSearchMovie> {
